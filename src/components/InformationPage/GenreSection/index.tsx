...
const cardsProps = [
	...
	{
		title: 'Esportes',
		description: 'Jogos que simulam esportes reais ou fictícios.'
	},
	{
		title: 'Estratégia',
		description:
	...
	{
		title: 'Simulação',
		description: 'Jogos que simulam situações reais ou fictícias.'
	}
];
	...
	return (
		...
		>
			...
			<Text as={'b'} fontSize={'25px'} color={'white'}>
				Os jogos podem ser divididos em diferentes gêneros, que são{' '}
				<br /> definidos com base em seus objetivos, elementos e estilo
				de jogo. <br />
				Alguns dos gêneros mais populares de jogos digitais incluem:
			</Text>
